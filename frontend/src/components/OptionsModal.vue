                  ...
                  <div class="p-4">
                    <ul class="grid grid-cols-2 mb-4">
                      <li
                        ...
                        :key="option"
                        @click="this.$emit('optionselected', option)"
                      >
                        <span
                          for="job-1"
                          class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 hover:text-blue-600 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500"
                        >
                          <div class="block">
