  ...
  <div class="p-6">
    ...
    >
      <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <select
          v-model="filters.arrangementDate"
          class="block w-full mb-4 p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
        ...
        <select
          v-model="filters.datePassed"
          class="block w-full mb-6 p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <option value="all">All</option>
    ...
    <table v-else class="min-w-full border border-collapse mt-6">
      ...
      <tbody>
        <template v-for="request in paginatedRequests" :key="request._id">
          <tr
            @click="toggleChildren(request)"
            class="cursor-pointer"
            :class="{ 'bg-gray-100': request.showChildren }"
            v-if="!request.isAdHoc"
          >
            ...
            <td class="border px-4 py-2">
              ...
              <button
                ...
                @click="openConfirmation(request.children)"
              ...
              <table class="w-full">
                ...
                <tbody>
                  <tr v-for="child in request.children" :key="child._id">
                    <td class="border px-4 py-2">
                      {{ new Date(child.request_date).toLocaleString() }}
                    </td>
                    ...
                    <td class="border px-4 py-2">
                      ...
                      <button
                        ...
                        @click="openConfirmation(child._id)"
                        class="text-red-500 hover:underline ml-2"
                      >
                        Cancel Request
                      </button>
    ...
    <div v-if="totalPages > 1" class="flex justify-center mt-4 space-x-4">
      <button
        ...
        class="bg-blue-500 text-white px-4 py-2 rounded disabled:bg-gray-400 hover:bg-blue-600 transition"
      >
        Previous
      </button>
      <button
    ...
    >
      <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <textarea
          ...
          id="reason"
          rows="3"
          class="w-full mt-2 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ></textarea>

        <div class="flex justify-end mt-4">
          <button
            @click="confirmCancellation"
            class="bg-red-500 text-white px-4 py-2 rounded mr-2 hover:bg-red-600 transition"
          >
            Yes, Cancel
          </button>
          <button
